...
This is my first project from CodeCrafters and their catalog of project challenges are definitely up my alley.
I enjoy learning more about how things work at the lower level, plus being able to learn in a project-based way,
even better!
...
that provides documentation and lessons related to the current challenge. The _Concepts_ section is fantastic. It
...
I have heard terms like TCP and IP thrown around here and there, I mean, who hasn't heard of an IP address? I just
wasn't aware what they were beyond the acronyms. I learned that they were protocols, and also what each protocol did exactly.
Reading more about them in the _Concepts_ section, I learned why IP is known as the _unreliable_ protocol:
...
At first I wasn't sure what was going on here. I didn't know what the socket module was for, nor how it fits into this
...
I learned quite a bit about networking protocols by creating a simple HTTP server. I really enjoyed how CodeCrafters organized
...
project is a good one to get some practice in those languages.
